jQuery(function ($) {
	...
	var guwahati = window.guwahati || {};

	/* ==================================================
		Contact Form Validations
	================================================== */
	guwahati.ContactForm = function () {
	...
	/* ==================================================
	   Twitter Widget
	================================================== */
	guwahati.TwitterWidget = function () {
	...
	/* ==================================================
	   Header Functions
	================================================== */
	guwahati.StickyHeader = function () {
		var windowWidth = $(window).width(),
			didScroll = false;
	...
	$(document).ready(function () {
		guwahati.ContactForm();
		guwahati.scrollToTop();
		guwahati.accordion();
		guwahati.toggle();
		guwahati.toolTip();
		guwahati.TwitterWidget();
		guwahati.galleryflex();
		guwahati.NivoSlider();
		guwahati.PrettyPhoto();
		guwahati.SuperFish();
		guwahati.Counters();
		guwahati.IsoTope();
		guwahati.StickyHeader();
		guwahati.MobileMenu();
		guwahati.heroflex();
	});
